    ...
    product_info = {
        'calcium': {
            ...
            'description': 'В качестве биологически активной добавки к пище - дополнительного '
                           ...
                           'витамина D3 и витамина К2. Входящий в состав кальций в биодоступной'
                           ' форме из аминокислотного '
                           'хелатного комплекса с витаминами D3 и К2 для максимального усвоения способствуют: '
                           'укреплению костной ткани, '
                           'зубов, ногтей и волос, направляет кальций «прямо в цель» - без отложения в почках, '
                           'суставах и сосудах; '
        ...
        'dihydroquercetin': {
            ...
            'description': 'Биологически активная добавка (БАД) к пище Дигидрокверцетин 100 мг –  это '
                           ...
                           'сибирской – уникальное по совокупности своих полезных свойств вещество. '
                           'Это более фармакологически'
                           'чистая форма кверцетина, которая не является токсичной даже при сверхвысоких дозах.'
                           ' В ходе многочисленных '
                           'научных исследований было доказано, что дигидрокверцетин способствует поддержанию '
                           'в норме вязкости крови'
                           ' и препятствует тромбообразованию. Дигидрокверцетин сохраняет здоровую эластичность, '
                           'прочность сосудов и '
        ...
        'magnesium': {
            ...
            'description': 'БАД к пище. Действие обусловлено свойствами компонентов, '
                           ...
                           'В состав используемого продукта могут быть включены не все перечисленные ниже '
                           'активные вещества.'
                           'Магний необходим для обеспечения энергетических процессов, отвечает за передачу '
                           'и скорость прохождения '
                           'нервного импульса от головного мозга к периферическим нервным окончаниям и мышца'
                           'м, участвует в процессах '
                           'ослабления нервно-мышечного напряжения, поддерживая нормальную нервно-мышечную '
                           'возбудимость, в том числе '
        ...
        'multiflora': {
            ...
            'description': 'Рекомендуется в качестве биологически активной добавки к пище – источника '
                           ...
                           'Синбиотик нового поколения (пробиотик+пребиотик). '
                           '7 видов живых бактерий в защитной двухслойной '
                           'оболочке попадают в кишечник в неизменном виде и способствуют: восстановлению'
...
async def get_formulas(call: types.CallbackQuery):
    await call.message.answer("Формула расчёта калорий:\n10 x вес (кг) + 6,25 x рост (см) – 5 x возраст (г) – 161")
    await call.answer()
...
async def set_username(message: types.Message, state: FSMContext):
    ...
    if crud_functions_14_5.is_included(message.text) != True:
...
async def set_age(message: types.Message, state: FSMContext):
    ...
    crud_functions_14_5.add_user(username=username, email=email, age=age, balance=balance)
